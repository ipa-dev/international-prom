            ...
            <?php foreach( $tabs as $tab => $name ) { ?>
                ...
                <div class="esb-cie-tab-content" id="<?php echo $tab ?>">
                    ...
                    <div class="metabox-holder">	
                        <div class="meta-box-sortables ui-sortable">
                            <div id="esb_cie_<?php echo $tab ?>" class="postbox">
                                ...
                                <div class="inside">
                                    ...
                                    <?php if($tab == 'gallery') { ?>
                                            <tr class="row-sizes">
                                                <td><input type="checkbox" id="esb_cie_sizes_gallery" name="esb_cie_column_name[]" value="sizes" checked="checked" /></td>
                                                <td class="row-title"><label for="esb_cie_sizes_gallery">Sizes</label></td>
                                                <td><code>sizes</code></td>
                                                <td><span class="description"></span></td>
                                            </tr>
                                            <tr class="row-colors">
                                                <td><input type="checkbox" id="esb_cie_colors_gallery" name="esb_cie_column_name[]" value="colors" checked="checked" /></td>
                                                <td class="row-title"><label for="esb_cie_colors_gallery">Colors</label></td>
                                                <td><code>colors</code></td>
                                                <td><span class="description"></span></td>
                                            </tr>
                                            <tr class="row-view">
                                                <td><input type="checkbox" id="esb_cie_view_gallery" name="esb_cie_column_name[]" value="view" checked="checked" /></td>
                                                <td class="row-title"><label for="esb_cie_view_gallery">View</label></td>
                                                <td><code>view</code></td>
                                                <td><span class="description"></span></td>
                                            </tr>
                                            <tr class="row-url">
                                                <td><input type="checkbox" id="esb_cie_url_gallery" name="esb_cie_column_name[]" value="redirect-url" checked="checked" /></td>
                                                <td class="row-title"><label for="esb_cie_url_gallery">Redirect URL</label></td>
                                                <td><code>url</code></td>
                                                <td><span class="description"></span></td>
                                            </tr>
                                            <tr class="row-url">
					    ...
					    <tr class="row-additional-images">
					    	<td><input type="checkbox" id="esb_cie_additional_images_gallery" name="esb_cie_column_name[]" value="additional-images" checked="checked" /></td>
					    	<td class="row-title"><label for="esb_cie_additional_images_gallery">Additional Images</label></td>
					    	<td><code>additional-images</code></td>
					    	<td><span class="description"></span</td>
					    </tr>
                                    <?php } ?>
                                    <?php if($tab == 'global_event') { ?>
                                            <tr class="row-event_date">
                                                <td><input type="checkbox" id="esb_cie_event_date_global_event" name="esb_cie_column_name[]" value="event_date" checked="checked" /></td>
                                                <td class="row-title"><label for="esb_cie_event_date_global_event">Event Date</label></td>
                                                <td><code>Event Date</code></td>
                                                <td><span class="description"></span></td>
                                            </tr>
                                            <tr class="row-event_time">
                                                <td><input type="checkbox" id="esb_cie_event_time_global_event" name="esb_cie_column_name[]" value="event_time" checked="checked" /></td>
                                                <td class="row-title"><label for="esb_cie_event_time_global_event">Event Time</label></td>
                                    ...
                                    <?php if ($tab == 'inventory') { ?>
                                    	<tr class="row-size">
                                    		<td><input type="checkbox" id="esb_cie_item_size_inventory" name="esb_cie_column_name[]" value="item-size" checked="checked" /></td>
                                    		<td class="row-title"><label for="esb_cie_item_size_inventory">Item Size</label></td>
                                    		<td><code>item-size</code></td>
                                    		<td><span class="description"></span></td>
                                    	</tr>
                                    	<tr class="row-color">
   						<td><input type="checkbox" id="esb_cie_item_color_inventory" name="esb_cie_column_name[]" value="item-color" checked="checked" /></td>
                                    		<td class="row-title"><label for="esb_cie_item_color_inventory">Item Color</label></td>
                                    		<td><code>item-color</code></td>
                                    		<td><span class="description"></span></td>
                                       	</tr>
                                       	<tr class="row-store">
                                       		<td><input type="checkbox" id="esb_cie_store_inventory" name="esb_cie_column_name[]" value="store" checked="checked" /></td>
                                    		<td class="row-title"><label for="esb_cie_store_inventory">Store</label></td>
