...
/**
 * Check post Meta and Get sizes
 */
function esb_cie_check_post_size( $post_size ) {
...
/**
 * Check post Meta and Get Colors
 */
function esb_cie_check_post_color( $post_color ) {
...
/**
 * Check post Meta and Get View
 */
function esb_cie_check_post_view( $view ) {
...
/**
 * Check post Meta and Get URL
 */
function esb_cie_check_post_url( $url ) {
...
/**
 * Check post Meta and Get Event date
 */
function esb_cie_check_event_date( $event_date ) {
...
/**
 * Check post Meta and Get Event time
 */
function esb_cie_check_event_time( $event_time ) {
    
    if( !empty( $event_time ) ) {
    	$newtime = date("g:i A", strtotime($event_time));
        $event_time = $newtime;
    } else {
        $event_time = '';
    }
