...
class FRemoteMediaExt extends WPCore\WPfeature
{
    ...
    public function initMediaLibrary()
    {
        ...
        if (is_admin()) {
            $this->addScript(new WPCore\WPscriptAdmin(array('upload.php' => array(), 'post.php' => array(), 'post-new.php' => array(), 'toplevel_page_gutenberg' => array()), 'media-remote-ext', $this->getJsUrl().'media-remote-ext.min.js', $this->getJsUrl().'media-remote-ext.js', array('media-editor','media-views'), $this->version));
