...
function mm_scripts_basic() {
    ...
    wp_enqueue_script( 'custom-fullcalendar', get_stylesheet_directory_uri().'/js/fullcalendar.js' );
    ...
    wp_enqueue_script( 'custom-moment', get_stylesheet_directory_uri().'/js/moment.min.js' );
