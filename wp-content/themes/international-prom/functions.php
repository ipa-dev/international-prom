...
function mm_scripts_basic() {
		...
		wp_enqueue_script( 'jquery-datetimepicker', $directory . '/js/jquery.datetimepicker.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker' ), true, true );
		wp_enqueue_script( 'custom-fullcalendar', $directory . '/node_modules/fullcalendar/dist/fullcalendar.min.js', array( 'jquery', 'custom-moment', 'jquery-ui-core', 'jquery-ui-datepicker' ), true, true );
