...
function mm_scripts_basic() {
		...
		wp_enqueue_script( 'custom-calendar', $directory . '/node_modules/angular-ui-calendar/src/calendar.js', array( 'custom-fullcalendar', 'jquery-datepicker', 'jquery-timepicker' ), true, true );
		...
		wp_enqueue_script( 'custom-script', $directory . '/js/custom-script.js', array( 'jquery', 'custom-angularjs', 'custom-calendar' ), true, true );
