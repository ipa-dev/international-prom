...
(function( factory ) {
	...
	*/
	$.validator.addMethod(
		"bankaccountNL", function(value, element) {
	...
	$.validator.addMethod(
		"bankorgiroaccountNL", function(value, element) {
	...
	*/
	$.validator.addMethod(
		"creditcardtypes", function(value, element, param) {
			if (/[^0-9\-]+/.test( value )) {
				return false;
			}
	 ...
	 */
	$.validator.addMethod(
		"giroaccountNL", function(value, element) {
	...
	$.validator.addMethod(
		"mobileNL", function(value, element) {
...
*/
	 ...
	 */
	$.validator.addMethod(
		"phoneNL", function(value, element) {
	...
	*/
	 ...
	 */
	$.validator.addMethod(
		"postalCodeCA", function( value, element ) {
	...
	*/
	$.validator.addMethod(
		"postalcodeBR", function(cep_value, element) {
	...
	$.validator.addMethod(
		"postalcodeIT", function(value, element) {
			return this.optional( element ) || /^\d{5}$/.test( value );
		}, "Please specify a valid postal code"
	);

	$.validator.addMethod(
		"postalcodeNL", function(value, element) {
	...
	$.validator.addMethod(
		"postcodeUK", function(value, element) {
	...
	*/
	...
	jQuery.validator.addMethod(
		"stateUS", function(value, element, options) {
	...
	$.validator.addMethod(
		"zipcodeUS", function(value, element) {
