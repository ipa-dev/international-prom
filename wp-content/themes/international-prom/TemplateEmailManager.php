		...
		?>
			<div class="section group">
				...
				<div class="col span_4_of_12">
					<a class="custom_button" href="https://login.mailchimp.com/oauth2/authorize?response_type=code&client_id=<?php echo getenv( 'MAILCHIMP_CLIENT_ID' ); ?>&redirect_uri=<?php echo urlencode( get_option( 'MAILCHIMP_REDIRECT_URI' ) ); ?>">Connect to MailChimp Account</a>
				</div>
				<div class="col span_4_of_12"></div>
			</div>
		<?php
