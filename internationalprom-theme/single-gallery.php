...
<div id="content">
	<div class="maincontent">
        <?php while (have_posts()) : the_post(); ?>
            <?php $category = get_the_terms(get_the_ID(), 'gallery_category');
            	if ($category[0]->slug == 'prom-dresses') $slug = $category[1]->slug;
            	else $slug = $category[0]->slug;
                                    ...
                                    <?php if(!empty($images)){ ?>
                                        <?php for($i = 1; $i < 6; $i++){ ?>
                                            <a class="simpleLens-thumbnail-wrapper" href="#" data-lens-image="<?php echo $images[$i]['url']; ?>" data-big-image="<?php echo $images[$i]['url']; ?>">
                                                <img src="<?php $url = explode('.', $images[$i]['url']);
                    ...
                    <div class="section group">
                        ...
                        <div class="col span_6_of_12">
                            ...
                            <div class="add-to-wish-list">
                                ...
                                <a href="javascript:void(0)" id="fav-<?php echo get_the_ID(); ?>" <?php if($isfav == 'active') { ?>onclick="removeFav<?php echo get_the_ID(); ?>();" title="[-] Remove from favorites"<?php } else { ?>onclick="addFav<?php echo get_the_ID(); ?>();" title="[+] Add as favorite"<?php } ?>><?php if($isfav == 'active') { ?>REMOVE FROM FAVORITES <i class="fa fa-heart"></i><?php } else { ?>ADD TO FAVORITES <i class="fa fa-heart-o"></i><?php } ?></a>
                                <?php } else { ?>
