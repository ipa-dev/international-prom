...
function mm_scripts_basic() {
		...
		wp_register_script( 'custom-angularjs', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.0.7/angular.min.js', array('jquery', 'datetime-picker', 'jquery-ui-core', 'jquery-ui-datepicker'));
