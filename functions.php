...
function mm_scripts_basic() {
		wp_enqueue_script( 'dollarsign-wrapper', get_stylesheet_directory_uri().'/js/dollarSignWrap.js');
    ...
    //wp_register_script( 'custom-calendar', get_stylesheet_directory_uri().'/js/calendar.js' );
		wp_register_script( 'custom-calendar', get_stylesheet_directory_uri().'node_modules/angular-ui-calendar/src/calendar.js', array('dollarsign-wrapper'));
