...
*/
/* This is for Gallery */
register_taxonomy('gallery_category', 'gallery',array("hierarchical" => true,"label" => "Designer Category","singular_label" => "Designer Category",'update_count_callback' => '_update_post_term_count','query_var' => true,'rewrite' => array( 'slug' => 'gallery_category', 'with_front' => false ),'adlic' => true,'show_ui' => true,'show_tagcloud' => true,'_builtin' => true,'show_in_nav_menus' => true));
...
function contentRefresh() {
    ...
    <div class="metro-tile">
        ...
        <?php if(!empty($_REQUEST['user_id'])) { ?><a href="javascript:void(0)" onclick="galleryDelete(<?php echo get_the_ID(); ?>)" class="metro-tile-delete"><i class="fa fa-trash"></i></a><?php } ?>
    </div>
    <?php
    endwhile;
    ?>
        ...
        <form>
            ...
            <div class="section group">
                ...
                <div class="col span_4_of_12" style="text-align: center;">
	                <?php if($type == 'email' || $type == 'sms') {} else { ?>
...
function dropPopup() {
    ...
    <div class="socialMediaPostContent">
        ...
        <form ng-submit="processForm()">
            ...
            <div class="section group">
                <div class="col span_2_of_12" style="text-align: center;">
                    <img class="attachedImage" width="50" height="50" style="vertical-align: middle;<?php if($_REQUEST['type'] == 'email') { ?> display: none;<?php } ?>" src="" />
                </div>
                <div class="col span_4_of_12">
	                <?php if($_REQUEST['type'] == 'email' || $_REQUEST['type'] == 'sms') {} else { ?>
...
function mm_scripts_basic() {
		...
		wp_register_script( 'custom-angularjs', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.0.7/angular.min.js', array('jquery', 'datetime-picker', 'jquery-ui-core', 'jquery-ui-datepicker', 'jquery-ui-timepicker'));
    //wp_register_script( 'custom-angularjs-route', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.0rc1/angular-route.min.js' );
		wp_register_script( 'jquery-ui-draggable', 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.9.2/jquery.ui.draggable.min.js', array('jquery', 'jquery-ui-core'));
...
register_taxonomy('global_event_category', 'global_even',array("hierarchical" => true,"label" => "Category","singular_label" => "Category",'update_count_callback' => '_update_post_term_count','query_var' => true,'rewrite' => array( 'slug' => 'global_event_category', 'with_front' => false ),'public' => true,'show_ui' => true,'show_tagcloud' => true,'_builtin' => true,'show_in_nav_menus' => false));
