...
<div id="my_acc">
	<div class="maincontent">
	    <div class="section group">
	        <div class="col span_12_of_12">
                <div class="acc_sec">
                <?php $store_name = get_user_meta($user_ID, 'store_name', true);
                ...
                <div class="section group">
                  <div class="location">
                   ...
                   <div class="col span_6_of_12">
                        ...
                        <?php if($role == 'retailer') { ?><p><strong>Website: </strong><a href="http://<?php echo get_post_meta( $results[$i]->ID, 'website', true); ?>" target="_blank"><?php echo get_post_meta( $results[$i]->ID, 'website', true); ?></a></p><?php } ?>
                        <?php if($role == 'retailer') { ?><p><strong>Store Description: </strong><?php echo get_post_meta( $results[$i]->ID, 'store_des', true); ?></p><?php } ?>
                        <p></p>
                        <p></p>
                   </div>
                   </div>
